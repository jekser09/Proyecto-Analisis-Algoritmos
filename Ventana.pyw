...
class Ventana():
    ...
    def ventana_Inicio(self)->None:
        ...
        #Paneles Tim
        self.__iniFrame=Frame(relief='groove',bd=6,bg='#368294',width=self.__wventana,height=self.__hventana)
        ...
        self.__titulo=Label(self.__iniFrame,text='Analisis de algoritmos',bg='#968D2D',font=('Cambria',20,BOLD),)
        self.__titulo.grid(row=0,column=0,columnspan=3,sticky=S+N+E+W)

        self.__subTitulo=Label(self.__iniFrame,text='Alagoritmos de ordenamiento',bg='#968D2D',font=('Cambria',20,BOLD))
        self.__subTitulo.grid(row=1,column=0,columnspan=3,sticky=S+N+E+W)

        self.__lblImg1=Label(self.__iniFrame,image=self.__iniImg1,bg='#368294')
        self.__lblImg1.rowconfigure(0,weight=1)
        self.__lblImg1.grid(row=2,column=0,sticky=S+N+E+W)
        self.__lblImg2=Label(self.__iniFrame,image=self.__iniImg1,bg='#368294')
        ...
        Label(self.__iniFrame,text='TimSort',relief='solid',bd=1,bg='#4FC8E3',font=('Cambria',10,BOLD)).grid(row=3,column=0,sticky=S+N+E+W)
        Label(self.__iniFrame,text='QuickSort',relief='solid',bd=1,bg='#4FC8E3',font=('Cambria',10,BOLD)).grid(row=3,column=1,sticky=S+N+E+W)
        Label(self.__iniFrame,text='BubbleSort',relief='solid',bd=1,bg='#4FC8E3',font=('Cambria',10,BOLD)).grid(row=3,column=2,sticky=S+N+E+W)

        Button(self.__iniFrame,image=self.__timImg,bg='#E3D339',bd=2,command=lambda:[wb.open(r'https://docs.google.com/presentation/d/1Fzru9vMW9SrbZx2Ep7Yv2TM14xN862Dd/edit#slide=id.p1',new=1,autoraise=True)]).grid(row=4,column=0,rowspan=2,sticky=S+N+E+W)
        Button(self.__iniFrame,image=self.__quickImg,bg='#E3D339',bd=2,command=lambda:[wb.open(r'https://www.genbeta.com/desarrollo/implementando-el-algoritmo-quicksort',new=1,autoraise=True)]).grid(row=4,column=1,rowspan=2,sticky=S+N+E+W)
        Button(self.__iniFrame,image=self.__bubbleImg,bg='#E3D339',bd=2,command=lambda:[wb.open(r'https://www.include-poetry.com/Code/C++/Metodos/Ordenamientos/Bubble-sort/',new=1,autoraise=True)]).grid(row=4,column=2,rowspan=2,sticky=S+N+E+W)

        Label(self.__iniFrame,text='Universidad Central',bg='#968D2D',font=('Cambria',16,BOLD)).grid(row=6,column=0,columnspan=3,sticky=S+N+E+W)
        Label(self.__iniFrame,text='Autor: Johand Esteban Castro Rodriguez',bg='#968D2D',font=('Cambria',16,BOLD)).grid(row=7,column=0,columnspan=3,sticky=S+N+E+W)
        Label(self.__iniFrame,text='Docente: Giovanny Alexander Briceño Riveros',bg='#968D2D',font=('Cambria',16,BOLD)).grid(row=8,column=0,columnspan=3,sticky=S+N+E+W)
        Label(self.__iniFrame,text='16/11/2022',bg='#968D2D',font=('Cambria',14,BOLD)).grid(row=9,column=0,columnspan=3,sticky=S+N+E+W)
    ...
    def ventana_Sort(self)->None:
        ...
        self.__imgDecor4=PhotoImage(file='Iconos/bombilla.png')
        ...
        self.__sortFrame=Frame(relief='groove',bd=6,bg='#096E60',width=self.__wventana,height=self.__hventana)
        ...
        Label(self.__sortFrame,text="DATOS ALEATORIOS",bg='#096E60',font=('Cambria',15,BOLD)).grid(row=0,column=0,columnspan=2)
        Label(self.__sortFrame,text="_Cantidad Datos_",bg='#096E60',font=('Cambria',15,BOLD)).grid(row=1,column=0,columnspan=2)
        Entry(self.__sortFrame,textvariable=self.__cantDatos,bg='#0EB09A',relief='groove',font=('Cambria',12,BOLD)).grid(row=2,column=0,columnspan=2)
        Label(self.__sortFrame,text="_Iteraciones_",bg='#096E60',font=('Cambria',15,BOLD)).grid(row=3,column=0,columnspan=2)
        Entry(self.__sortFrame,textvariable=self.__iteraciones,bg='#0EB09A',relief='groove',font=('Cambria',12,BOLD)).grid(row=4,column=0,columnspan=2)
        Label(self.__sortFrame,text="_Avance_",bg='#096E60',font=('Cambria',15,BOLD)).grid(row=5,column=0,columnspan=2)
        Entry(self.__sortFrame,textvariable=self.__avance,bg='#0EB09A',relief='groove',font=('Cambria',12,BOLD)).grid(row=6,column=0,columnspan=2)
        Label(self.__sortFrame,text="_Tipo De Datos_",bg='#096E60',font=('Cambria',15,BOLD)).grid(row=7,column=0,columnspan=2)
        Checkbutton(self.__sortFrame,text="Numeros",command=lambda:[self.check_Bot(1)],bg='#096E60',font=('Cambria',12,BOLD),variable=self.__checkNum,).grid(row=8,column=0)
        Checkbutton(self.__sortFrame,text="Palabras",command=lambda:[self.check_Bot(0)],bg='#096E60',font=('Cambria',12,BOLD),variable=self.__checkPal,).grid(row=8,column=1)
        Button(self.__sortFrame,image=self.__imgPlay,command=lambda:[self.pintar_Grafica(True)],bg='#12E3C7',bd=2).grid(row=9,column=0,columnspan=2,sticky=EW)
        ttk.Separator(self.__sortFrame,orient='horizontal',).grid(row=10,column=0,columnspan=2,sticky=EW)
        Label(self.__sortFrame,text="ARCHIVOS",bg='#096E60',font=('Cambria',15,BOLD)).grid(row=11,column=0,columnspan=2)
        Label(self.__sortFrame,text="_Crear Archivos_",bg='#096E60',font=('Cambria',15,BOLD)).grid(row=12,column=0,columnspan=2)
        ...
        Button(self.__sortFrame,image=self.__imgCrear,command=lambda:[self.crear_Csvs()],bg='#12E3C7',bd=2).grid(row=14,column=0,columnspan=2,sticky=EW)
        Label(self.__sortFrame,text="_Cargar Archivos_",bg='#096E60',font=('Cambria',15,BOLD)).grid(row=15,column=0,columnspan=2)
        Button(self.__sortFrame,image=self.__imgSubir,bg='#12E3C7',bd=2,command=self.dir_carpeta).grid(row=16,column=0,columnspan=2,sticky=EW)
        Button(self.__sortFrame,image=self.__imgPlay,command=lambda:[self.pintar_Grafica(False)],bg='#12E3C7',bd=2).grid(row=17,column=0,columnspan=2,sticky=EW)
        Label(self.__sortFrame,image=self.__imgDecor1,bg='#096E60',font=('Cambria',15,BOLD)).grid(row=18,column=0,columnspan=2)
        Button(self.__sortFrame,image=self.__imgDecor2,command=lambda:[self.graf_Tabla(1)],bg='#12E3C7',bd=2,).grid(row=18,column=2,padx=5,sticky=EW)
        Button(self.__sortFrame,image=self.__imgDecor4,command=lambda:[wb.open(r'https://github.com/jekser09/Proyecto-Analisis-Algoritmos',new=1,autoraise=True)],bg='#12E3C7',bd=2,).grid(row=18,column=3,padx=5)
        Button(self.__sortFrame,image=self.__imgDecor3,command=lambda:[self.graf_Tabla(0)],bg='#12E3C7',bd=2,).grid(row=18,column=4,padx=5,sticky=EW)
        #Grafica
        self.fig=Figure()
